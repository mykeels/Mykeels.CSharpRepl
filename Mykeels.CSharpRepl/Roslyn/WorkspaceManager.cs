...
internal sealed class WorkspaceManager
{
    ...
    )
    {
        ...
        var assemblyReferences = referenceAssemblyService.EnsureReferenceAssemblyWithDocumentation(
    ...
    )
    {
        ...
        return solution.AddProject(projectInfo).AddDocument(documentInfo);
    }
    ...
    private static ProjectInfo CreateProject(
        ...
        ProjectInfo
            ...
            .WithProjectReferences(
                solution.ProjectIds.TakeLast(1).Select(id => new ProjectReference(id))
            )
            .WithCompilationOptions(compilationOptions);

    private const string RoslynWorkspaceErrorFormat =
