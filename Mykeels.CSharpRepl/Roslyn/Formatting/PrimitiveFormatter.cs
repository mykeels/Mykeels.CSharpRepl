...
internal sealed class PrimitiveFormatter
{
        ...
        switch (GetPrimitiveSpecialType(type))
        {
            ...
            default:
                throw new InvalidOperationException(
                    $"Unexpected type '{GetPrimitiveSpecialType(type)}'"
                );
        }
    }
    ...
    private StyledStringSegment FormatLiteral(
        string value,
        bool useQuotes,
    ...
    )
    {
        var options = GetObjectDisplayOptions(
            useQuotes: useQuotes,
            escapeNonPrintable: escapeNonPrintable,
            includeCodePoints: includeCodePoints,
            numberRadix: numberRadix
        );
    ...
    {
        return new(
            ObjectDisplay.FormatLiteral(value, ObjectDisplayOptions.None, cultureInfo),
            numericLiteralFormat
        );
    }
