...
internal abstract class CustomObjectFormatter : ICustomObjectFormatter
{
    ...
    public virtual FormattedObjectRenderable FormatToRenderable(
        object value,
        Level level,
        Formatter formatter
    ...
    where T : notnull
{
    ...
    public sealed override StyledString FormatToText(
        object value,
        Level level,
        Formatter formatter
    ) => FormatToText((T)value, level, formatter);

    public sealed override FormattedObjectRenderable FormatToRenderable(
        object value,
        Level level,
        Formatter formatter
...
internal class Formatter
{
    ...
    public Style GetStyle(string? classification) => syntaxHighlighter.GetStyle(classification);
