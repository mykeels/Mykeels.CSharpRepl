...
public readonly struct ThemeColor
{
    ...
    public AnsiColor ToAnsiColor()
    {
        ...
        throw new ArgumentException(
            $"Unknown recognized color '{Value}'. Expecting either a hexadecimal color of the format #RRGGBB or a standard ANSI color name"
        );
    }
    ...
    private static bool TryConvertAnsiColorToConsoleColor(
        string ansiColorName,
        out ConsoleColor result
    )
    {
