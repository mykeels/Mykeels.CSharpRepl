...
public sealed class StyledStringBuilder
{
    ...
    [Obsolete(
        "Do not use this overload. You need to pass Style object and not string implicitly parsed to Style."
    )]
    public StyledStringBuilder(string? text, string style) => throw new NotSupportedException();
