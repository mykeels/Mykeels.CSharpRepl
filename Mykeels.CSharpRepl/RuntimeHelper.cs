...
{
    public static SpanOutput HandleSpanOutput<T>(System.Span<T> span) =>
        SpanOutput.Create<T>(span, typeof(System.Span<T>));

    public static SpanOutput HandleSpanOutput<T>(System.ReadOnlySpan<T> span) =>
        SpanOutput.Create(span, typeof(System.ReadOnlySpan<T>));

    public static CharSpanOutput HandleSpanOutput(System.Span<char> span) =>
        CharSpanOutput.Create(span, typeof(System.Span<char>));

    public static CharSpanOutput HandleSpanOutput(System.ReadOnlySpan<char> span) =>
        CharSpanOutput.Create(span, typeof(System.ReadOnlySpan<char>));

    public static SpanOutput HandleMemoryOutput<T>(System.Memory<T> memory) =>
        SpanOutput.Create<T>(memory.Span, typeof(System.Memory<T>));

    public static SpanOutput HandleMemoryOutput<T>(System.ReadOnlyMemory<T> memory) =>
        SpanOutput.Create(memory.Span, typeof(System.ReadOnlyMemory<T>));

    public static CharSpanOutput HandleMemoryOutput(System.Memory<char> memory) =>
        CharSpanOutput.Create(memory.Span, typeof(System.Memory<char>));

    public static CharSpanOutput HandleMemoryOutput(System.ReadOnlyMemory<char> memory) =>
        CharSpanOutput.Create(memory.Span, typeof(System.ReadOnlyMemory<char>));
        ...
        : SpanOutputBase(originalLength, originalType)
    {
        ...
        public static SpanOutput Create<T>(System.ReadOnlySpan<T> span, System.Type originalType) =>
            new(
        ...
        : SpanOutputBase(originalLength, originalType)
    {
        ...
        public static CharSpanOutput Create(
            System.ReadOnlySpan<char> span,
