...
4. **Docs + sample**: add `Mykeels.CSharpRepl.Sample` opt-in path and a README section describing Slack app setup (scopes, tokens, slash command registration). Not yet done.
